import { Bug, Search, AlertTriangle, Eye, BarChart, Shield, Database, Server, Lock } from "lucide-react";
    ...
    <section className="py-16 bg-cyber-bg-darker">
      <div className="container mx-auto px-4">
        <div className="max-w-4xl mx-auto">
          <h1 className="text-4xl md:text-5xl font-bold mb-8 text-center text-cyber-purple">
            Servicios de Ciberseguridad y Soluciones de Protección Digital
          </h1>
          ...
          <div className="mt-16 text-center bg-cyber-bg p-8 rounded-lg border border-cyber-border">
            ...
            <div className="max-w-2xl mx-auto">
              <div className="bg-cyber-bg-darker p-6 rounded-lg">
                ...
                <a href="/contact" className="inline-block bg-cyber-purple hover:bg-cyber-purple/90 text-white px-6 py-2 rounded-md transition-colors">Contactar Ahora</a>
              </div>
            </div>
